...
namespace Pulumi.ProviderNetcup
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.ProviderNetcup.version.txt");
    ...
    internal sealed class ProviderNetcupResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ProviderNetcupResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
