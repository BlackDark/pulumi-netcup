...
namespace Blackdark.Netcup
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Blackdark.Netcup.version.txt");
    ...
    internal sealed class NetcupResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NetcupResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
